...
| 2026-04-26 | [Running Point S2 top US Netflix show](./reasoning/2026-04-26-running-point-netflix-top-us-show.md) | Polymarket | 92.4% YES | 91.0% (+1.4pp toward prediction; raw YES -1.4pp) | 95.1% (-2.7pp away from prediction; raw YES +2.7pp) | n/a (after close) | pending | Short-horizon v3 prediction against a 92% market after official US Netflix top 10 page did not list Running Point. +1h moved slightly toward the NO thesis, +6h reversed above entry, then 15:07Z price-move wake marked 87.55% YES (+4.85pp aligned from entry) on a wide book. 16:07Z marked 43.5% YES (+48.9pp aligned from entry) on an extremely wide book; 16:10Z tightened to 13.75% YES (+78.65pp aligned from entry). Fresh Tudum fetch still excluded Running Point from the US TV top 10. |
| 2026-04-27 | [Elon Musk 220-239 posts Apr 21-28](./reasoning/2026-04-27-elon-musk-tweets-apr21-apr28-220-239.md) | Polymarket | 23.5% YES | 25.5% (+2.0pp) | 49.5% (+26.0pp) | pending | pending | Short-horizon XTracker range-bin prediction. At writing tracker showed 181 counted posts with ~27.6h left; thesis is that market over-weighted the recent quiet stretch and underpriced the 39-58 remaining-post interval. +1h moved modestly toward the YES thesis; +6h reached 49.5% YES (+26.0pp) with XTracker at 198; 20:26Z eased to 43.5% YES (+20.0pp) with XTracker at 213; 21:28Z eased to 39.5% YES (+16.0pp) with XTracker at 215 and overrun risk dominant. Market remains above the 35% forecast. |
| 2026-04-27 | [Trump 100-119 Truth Social posts Apr 21-28](./reasoning/2026-04-27-trump-truth-social-posts-apr21-apr28-100-119.md) | Polymarket | 5.15% YES | 6.85% (+1.7pp) | 10.25% (+5.1pp) | pending | pending | Short-horizon XTracker range-bin prediction. At writing tracker showed 105 counted posts with ~27.6h left; thesis is that market over-anchored on 123 pace / 120-139 modal bucket and underpriced staying below 120 after a quiet 24h. +1h/+6h moved toward the YES thesis; 20:11Z reached 18.65% YES (+13.5pp from entry) after XTracker rose to 114, then 20:26Z collapsed to 1.4% YES (-3.75pp from entry) as the market repriced the tiny 0-5 post cushion. |
| 2026-04-27 | [White House 140-159 posts Apr 21-28](./reasoning/2026-04-27-white-house-posts-apr21-apr28-140-159.md) | Polymarket | 52.0% YES | 56.0% (+4.0pp) | 79.5% (+27.5pp) | pending | pending | Short-horizon XTracker range-bin prediction. At writing tracker showed 124 counted posts with ~27.5h left; thesis is that 16-35 more posts is the natural modal interval after a quiet night and current market over-allocates to 160-179. +1h/+6h moved toward the YES thesis, but later moves reversed as overrun risk rose: 20:26Z 64.5% YES (+12.5pp), 20:56Z 47.5% YES (-4.5pp) with XTracker at 144 and only 0-15 posts of cushion. |
| 2026-04-27 | [Powell says "Pandemic" during April press conference](./reasoning/2026-04-27-powell-pandemic-april-press-conference.md) | Polymarket | 74.5% YES | 73.0% (-1.5pp) | pending | pending | pending | Short-horizon Fed word-market prediction. Official Fed PDF transcripts showed Powell himself said `pandemic`/`pandemics` in 17 of the last 18 press conferences, including both 2026 meetings; thesis is that the market underpriced sticky pandemic-comparison vocabulary. +1h drifted slightly away but stayed inside ordinary spread/noise. |
