...
| 2026-04-28 | [Amazon GAAP EPS > $1.65](./reasoning/2026-04-28-amzn-gaap-eps-q1-2026.md) | Polymarket | 92.15% YES | 92.15% (+0.0pp toward prediction; raw YES -0.0pp) | pending | pending | pending | Short-horizon earnings-beat prediction below market: 80% YES vs 92.15% entry. Thesis is that the usual consensus-beat skew is real but overprices this as near-certain when current raw consensus is only $1.653, the strike is strict >$1.65, revisions are mixed, and recent AMZN GAAP history is 3/4 beats with one one-cent miss. +1h unchanged on a tight book. |
