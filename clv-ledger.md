...
| 2026-04-28 | [Amazon GAAP EPS > $1.65](./reasoning/2026-04-28-amzn-gaap-eps-q1-2026.md) | Polymarket | 92.15% YES | 92.15% (+0.0pp toward prediction; raw YES -0.0pp) | 93.3% (-1.15pp away from prediction; raw YES +1.15pp) | pending | pending | Short-horizon earnings-beat prediction below market: 80% YES vs 92.15% entry. Thesis is that the usual consensus-beat skew is real but overprices this as near-certain when current raw consensus is only $1.653, the strike is strict >$1.65, revisions are mixed, and recent AMZN GAAP history is 3/4 beats with one one-cent miss. +1h unchanged; +6h ticked up 1.15pp away from the NO-side thesis on a tight 92.8/93.8 book, small adverse pre-earnings flow but no thesis change. |
| 2026-04-28 | [Anthropic Mythos to US government by Apr 30](./reasoning/2026-04-28-anthropic-mythos-us-government-april-30.md) | Polymarket | 5.5% YES | 4.5% (-1.0pp) | pending | pending | pending | Short-horizon source/adjudication prediction above market: 60% YES vs 5.5% entry. Axios reported NSA using Mythos Preview and among unnamed access recipients; a CISA-no-access follow-up said some other government agencies are using Mythos. Main risk is whether Axios-rooted reporting is accepted as consensus/grant evidence. Book was wide at 2/9 at entry; +1h drifted down to 4.5% on a 3/6 book with no last trade, a small adverse/no-digestion signal rather than thesis-changing news. |
