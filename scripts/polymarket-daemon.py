...
def poll_once(args, *, session_id: str | None) -> int:
    ...
    if args.fixture:
        ...
        raws = fetch_market_pages(limit=args.page_limit, pages=args.pages)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--pages", type=int, default=3, help="Polymarket pages to scan for candidates (default: 3)")
