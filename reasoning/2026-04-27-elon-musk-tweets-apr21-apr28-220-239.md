...
- 2026-04-28T06:35Z: Polymarket moved down to **55.0% YES** (54% bid / 56% ask; last trade 60%), still **+31.5pp from entry** and far above the original 35% forecast. XTracker sync 06:35:38 showed **227 counted posts** after five posts in the prior 30 minutes; the bin is now active but has only **0-12 posts** of cushion with ~9.4h left. Partial-count analogs around 224-230, especially with recent activity, make overrun above 239 the dominant risk. The move down is directionally sensible, but current YES still does not look cheap.
- 2026-04-28T06:50Z: Polymarket bounced back to **70.5% YES** (70% bid / 71% ask), **+47.0pp from entry**. XTracker still showed **227 counted posts** at sync 06:50:37, with no posts in the prior 15 minutes and ~9.2h left. This mostly reversed the 06:35 alert back near the prior price without a source update; analogs still put overrun above 239 as the larger risk, so this is market ping-pong rather than renewed evidence for the original YES thesis.
- 2026-04-28T12:26Z: +24h checkpoint marked **63.0% YES** but on a very wide **27% / 99%** book with only ~$47 liquidity, so the exact mark is not reliable executable CLV. Directionally, it is still **+39.5pp from entry**. XTracker sync 12:26:05 still showed **227 counted posts**, no posts for ~6.0h, leaving **0-12 posts** of cushion with ~3.6h left. The original underpricing call got strong CLV; final outcome now depends on whether another burst arrives before close.
- 2026-04-28T12:41Z: Polymarket tightened/rebounded to **76.5% YES** (74% bid / 79% ask; last trade 73%), **+53.0pp from entry**. XTracker still showed **227 counted posts**, no posts for ~6.3h, leaving **0-12 posts** of cushion with ~3.3h left. Broad partial-count analogs put staying in-bin around the low/mid-80s; the small conditioned samples are noisy but the market move is consistent with the long quiet stretch. The live price is closer to fair than to a fresh edge.
