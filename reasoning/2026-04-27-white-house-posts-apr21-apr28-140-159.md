...
- 2026-04-28T00:13Z: Polymarket continued down to **30.5% YES** on a tighter **28% / 33%** book (last trade 32%), **-21.5pp from entry**. XTracker count was still **150** at sync 00:15:26, so this is mostly the market digesting the 23:43-23:46 burst rather than new posts. The tighter book makes the adverse signal cleaner than the prior wide 40.5% mark: with only 0-9 posts of cushion and ~15.8h left, the original 65% forecast is now badly underwater.
- 2026-04-28T00:28Z: Polymarket marked **18.0% YES** on a very wide **6% / 30%** book (last trade 22%), **-34.0pp from entry**. XTracker sync 00:25:46 showed **151 counted posts** after one more post at 00:20, leaving only **0-8 posts** of cushion and ~15.5h left. This is directionally adverse but less clean than the 00:13 tight book because the spread widened sharply; logged the automation lesson to suppress ordinary wide-book stair-step wakes unless the move is extreme.
- 2026-04-28T02:18Z: Polymarket rebounded to **39.0% YES** (34% bid / 44% ask; last trade 30%), still **-13.0pp from entry**. XTracker sync 02:15:49 showed **152 counted posts** after only one post in the prior hour, leaving **0-7 posts** of cushion and ~13.7h left. The quiet stretch explains the rebound, but the cushion is now so small that any ordinary morning/daytime posting block can overrun the bin; no renewed YES edge.
- 2026-04-28T03:18Z: Polymarket rebounded further to **58.5% YES** (56% bid / 61% ask; last trade 56%), now **+6.5pp from entry** but still below the original 65% forecast. XTracker sync 03:15:47 still showed **152 counted posts**, no posts in the prior hour, and ~12.7h left. The rebound is understandable under overnight inactivity, but partial-count analogs around 150-154 still make overrun above 159 the larger risk unless conditioning heavily on same-hour quiet. Current price is not a renewed YES edge.
- 2026-04-28T04:50Z: Polymarket dropped to **23.5% YES** (21% bid / 26% ask; last trade 24%), **-28.5pp from entry**. XTracker sync 04:50:27 showed **154 counted posts** after two more posts at 04:24, leaving only **0-5 posts** of cushion and ~11.2h left. Partial-count analogs around 152-156 put staying within 140-159 near ~20% under recent-activity conditioning, with overrun above 159 dominant. This is strong adverse evidence against the original forecast.
- 2026-04-28T12:41Z: +24h checkpoint marked **42.5% YES**, **-9.5pp from entry**, but on a very wide **3% / 82%** book with only about **$48 liquidity** and no last trade, so the exact mark is not meaningful executable CLV. XTracker sync 12:46:03 still showed **154 counted posts**, no posts since 04:24 (~8.4h), leaving **0-5 posts** of cushion with ~3.2h left. Broad partial-count analogs around 152-156 still show large overrun risk, but the long gap conditioning supports staying in-bin; final outcome is live and now mostly depends on whether any late White House posting block arrives before noon ET.
- 2026-04-28T13:16Z: Polymarket moved down to **26.0% YES** (18% bid / 34% ask; last trade 17%), **-26.0pp from entry**. XTracker sync 13:16:01 showed **156 counted posts** after two new posts at 12:47 and 12:54, leaving only **0-3 posts** of cushion with ~2.7h left. Conditioned analogs at partial 154-158 with a post in the prior hour are small but put overrun close to a coin flip; the market is reacting to the right source signal. This is another adverse update against the original 65% forecast, though not source-decisive until the count reaches 160 or the window closes.
