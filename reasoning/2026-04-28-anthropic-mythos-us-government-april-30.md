...
- 2026-04-30T06:50Z: Polymarket mark was **18.35% YES** after drifting down from a daemon-observed **23.6%** mark (9.0% bid / 27.7% ask; last trade 14.3%; liquidity ~$3.5k). This is **+12.85pp from entry** despite the immediate -5.25pp move, but the book is very wide and the market is still active after the listed end time. I read this as resolution-watch repricing toward a nonzero YES/adjudication chance, not clean CLV quality or a thesis change.
- 2026-04-30T14:36Z: Polymarket repriced sharply to **72.0% YES** from a daemon-observed **31.9%** mark (56.2% bid / 87.8% ask; last trade 81.0%; liquidity ~$8.7k). This is **+66.5pp from entry** and now above my 60% forecast, a major market move toward the original Axios/credible-reporting thesis. It still is not final resolution: the market remains active after the listed end time and the book is extremely wide, so treat this as strong resolution-watch evidence rather than settled outcome.
- 2026-04-30T14:51Z: Polymarket moved further to **91.95% YES** (90.0% bid / 93.9% ask; last trade 95.0%; liquidity ~$20.0k), **+86.45pp from entry**. Unlike the 14:36 mark, this is a much tighter executable book and looks like the market is converging on YES adjudication. Still waiting for the actual closed/resolution state before scoring.
