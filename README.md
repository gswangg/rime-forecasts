...
- **24 predictions placed; 14 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 14 v3 short-horizon Polymarket predictions. Latest prediction: Cerebras IPO market cap `<$50B` at close, a source/rule thesis that Polymarket may be pricing fully diluted valuation while its description specifies outstanding shares. Current resolved Brier: **0.152** vs primary-venue entry Brier **0.280**.
