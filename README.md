...
- **35 predictions placed; 24 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 25 v3 short-horizon Polymarket predictions. Latest resolution: `Michael` 4th weekend `$22m-$25m` resolved NO after The Numbers finalized the weekend above $25m. Current resolved Brier: **0.158** vs primary-venue entry Brier **0.302**.
