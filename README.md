...
- **32 predictions placed; 18 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 22 v3 short-horizon Polymarket predictions. Latest resolution: confirmed Hantavirus case in US by May 15 resolved YES after late UMA finalization. Current resolved Brier: **0.150** vs primary-venue entry Brier **0.296**.
