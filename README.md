...
- **23 predictions placed; 11 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 13 v3 short-horizon Polymarket predictions. Latest resolved update: Michael 2nd weekend box office `>$55m` resolved NO after The Numbers/Box Office Mojo finalized at `$54.403m`. Current resolved Brier: **0.174** vs primary-venue entry Brier **0.315**.
