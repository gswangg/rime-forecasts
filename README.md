...
- **23 predictions placed; 12 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 13 v3 short-horizon Polymarket predictions. Latest resolved update: ON Semiconductor non-GAAP EPS `>$0.61` resolved YES after onsemi reported `$0.64`. Current resolved Brier: **0.162** vs primary-venue entry Brier **0.290**.
