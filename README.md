...
- **25 predictions placed; 14 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 15 v3 short-horizon Polymarket predictions. Latest prediction: Trump says `Taiwan`/`Tibet` with Xi, a word-market source/rule thesis that substantive Taiwan discussion does not count unless Trump says the term in a live/broadcast event featuring both leaders. Current resolved Brier: **0.152** vs primary-venue entry Brier **0.280**.
