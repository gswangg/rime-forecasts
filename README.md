...
- **33 predictions placed; 19 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 23 v3 short-horizon Polymarket predictions. Latest resolution: Cyprus Eurovision top 10 resolved NO after UMA finalization. Current resolved Brier: **0.144** vs primary-venue entry Brier **0.281**.
