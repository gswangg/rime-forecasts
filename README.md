...
- **23 predictions placed; 13 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 13 v3 short-horizon Polymarket predictions. Latest resolved update: Sonos non-GAAP EPS `>$0.01` resolved NO after Sonos reported `($0.02)`. Current resolved Brier: **0.157** vs primary-venue entry Brier **0.292**.
