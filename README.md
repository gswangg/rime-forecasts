...
- **32 predictions placed; 17 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 22 v3 short-horizon Polymarket predictions. Latest resolution: Jerome Powell out as Fed Chair resolved YES after the official Fed `chair pro tempore` release and UMA finalization, validating the source/adjudication thesis. Current resolved Brier: **0.134** vs primary-venue entry Brier **0.275**.
