...
- **30 predictions placed; 15 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 20 v3 short-horizon Polymarket predictions. Latest resolution: Cerebras IPO market cap `<$50B` resolved NO after CBRS closed at $311.07 / ~$66.95B even on basic outstanding shares. Current resolved Brier: **0.150** vs primary-venue entry Brier **0.261**.
