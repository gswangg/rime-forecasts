...
- [`scripts/options-chain-fetch.py`](./scripts/options-chain-fetch.py) — fetches/normalizes option-chain snapshots from fixture or Tradier market-data provider (`TRADIER_TOKEN` required for Tradier) for thesis fixtures and markouts.
