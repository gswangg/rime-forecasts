...
- **34 predictions placed; 22 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 24 v3 short-horizon Polymarket predictions. Latest resolution: Trump `Make America Great Again` exact-phrase market resolved NO after UMA finalization. Current resolved Brier: **0.166** vs primary-venue entry Brier **0.314**.
