...
- **21 predictions placed; 9 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 11 v3 short-horizon Polymarket predictions (Running Point top US Netflix show; Elon Musk 220-239 posts; Trump 100-119 Truth Social posts; White House 140-159 posts; Powell says `Pandemic`; AMZN GAAP EPS > `$1.65`; Anthropic Mythos to US government; White House 160-179 posts Apr 24-May 1; TSLA high $390 week of Apr 27; Michael 2nd weekend box office > `$55m`; Elon Musk <40 posts May 2-May 4). Current resolved Brier: **0.203** vs primary-venue entry Brier **0.364**.
