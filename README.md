...
- **23 predictions placed; 10 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 13 v3 short-horizon Polymarket predictions. Latest resolved update: Elon Musk `<40` posts May 2-May 4 resolved NO after XTracker counted 55 in-window posts. Current resolved Brier: **0.183** vs primary-venue entry Brier **0.329**.
