...
- **34 predictions placed; 23 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 24 v3 short-horizon Polymarket predictions. Latest resolution: Strategy/MicroStrategy `>1000 BTC` purchase announcement resolved YES after the official May 18 purchase page update. Current resolved Brier: **0.159** vs primary-venue entry Brier **0.301**.
