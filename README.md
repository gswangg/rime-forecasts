...
- **31 predictions placed; 16 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 21 v3 short-horizon Polymarket predictions. Latest resolution: Trump says `Taiwan`/`Tibet` with Xi resolved NO, validating the rule-specific word-market thesis. Current resolved Brier: **0.143** vs primary-venue entry Brier **0.250**.
