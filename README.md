...
- **26 predictions placed; 14 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 16 v3 short-horizon Polymarket predictions. Latest prediction: confirmed Hantavirus case in the US by May 15, a pending-test/source-timing thesis around a repatriated cruise passenger with an inconclusive/weak positive and CDC retesting in U.S. territory. Current resolved Brier: **0.152** vs primary-venue entry Brier **0.280**.
