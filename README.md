...
- **33 predictions placed; 21 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 23 v3 short-horizon Polymarket predictions. Latest resolution: Finland Eurovision top 5 resolved NO after UMA finalization. Current resolved Brier: **0.173** vs primary-venue entry Brier **0.323**.
