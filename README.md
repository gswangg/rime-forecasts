...
- **27 predictions placed; 14 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 17 v3 short-horizon Polymarket predictions. Latest prediction: Jerome Powell out as Fed Chair by May 15, a source-decisive succession thesis after Powell said he would step aside on May 15 and the Senate officially confirmed Kevin Warsh as Fed Chair. Current resolved Brier: **0.152** vs primary-venue entry Brier **0.280**.
