...
- [`scripts/options-daemon.py`](./scripts/options-daemon.py) — shadow-only options funnel. Reads fixture-defined option chains and thesis structures, applies quote-quality / max-risk / edge gates, and prints or emits `options_signal_candidate` wakes. No broker/live trading.
