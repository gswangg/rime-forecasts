...
- **35 predictions placed; 23 resolved**: 8 v1 baseline, 1 v2 Manifold prediction (WTI crude $150), 1 v2.5.2 Polymarket-primary prediction (Tottenham relegation), and 25 v3 short-horizon Polymarket predictions. Latest new prediction: The Deep dies in `The Boys: Season 5` at 88% YES vs 74.5% Polymarket. Current resolved Brier: **0.159** vs primary-venue entry Brier **0.301**.
